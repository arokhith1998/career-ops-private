# Coinbase - Senior Enterprise Product  Marketing Manager, Base

**Company:** Coinbase
**Title:** Senior Enterprise Product  Marketing Manager, Base
**URL:** https://www.coinbase.com/careers/positions/8084049?gh_jid=8084049
**Req/Posting ID:** 8084049 (Greenhouse job id / gh_jid)
**Updated At:** 2026-07-27T16:43:23-04:00
**Location(s):** Remote - USA
**Metadata:** Team: Marketing; HM Employee ID (WD): 208989; Careersite Department (for job postings): Marketing & Communications
**Source:** Greenhouse boards-api (boards-api.greenhouse.io/v1/boards/coinbase/jobs/8084049?content=true)
...
We're hiring a Senior Product Marketing Manager to own enterprise and B2B product marketing for Base, focused on financial markets. The Base Marketing team drives adoption of Base as the default chain for enterprises building onchain. You'll set the go-to-market strategy for institutional use cases, build the proof engine that turns enterprise wins into pipeline, and lead the launches that position Base as the infrastructure layer for onchain trading, lending, and tokenization.
